...
public class ReviewDaoTest {
	...
	public void getReviewByPlaceIdTest() {
		ReviewDaoImpl rdi = new ReviewDaoImpl();
		assertNotNull(rdi.getReviewsByPlace(rdi.getReviewById(2).getLocationList().getPlaceId()));
	...
	public void addReviewTest() {
		...
		int fakeReviewLocationId = fakeReview.getLocationList().getLocationId();
		int fakeReviewUserId = fakeReview.getPerson().getPersonID();
		
		Review fakeReviewTwo = new Review(fakeReviewLocationId, fakeReviewUserId, "that's my truck", 
